...
model= gensim.models.KeyedVectors.load_word2vec_format('/home/abhinav/fake_news/google_news/GoogleNews-vectors-negative300.bin.gz',limit=500000, binary=True)
